...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumBGPBFD) DeepEqual(other *CiliumBGPBFD) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumBGPBFDState) DeepEqual(other *CiliumBGPBFDState) bool {
	if other == nil {
		return false
	}

	if (in.SessionState == nil) != (other.SessionState == nil) {
		return false
	} else if in.SessionState != nil {
		if *in.SessionState != *other.SessionState {
			return false
		}
	}

	if (in.RemoteSessionState == nil) != (other.RemoteSessionState == nil) {
		return false
	} else if in.RemoteSessionState != nil {
		if *in.RemoteSessionState != *other.RemoteSessionState {
			return false
		}
	}

	if (in.LocalDiagnosticCode == nil) != (other.LocalDiagnosticCode == nil) {
		return false
	} else if in.LocalDiagnosticCode != nil {
		if *in.LocalDiagnosticCode != *other.LocalDiagnosticCode {
			return false
		}
	}

	if (in.RemoteDiagnosticCode == nil) != (other.RemoteDiagnosticCode == nil) {
		return false
	} else if in.RemoteDiagnosticCode != nil {
		if *in.RemoteDiagnosticCode != *other.RemoteDiagnosticCode {
			return false
		}
	}

	if (in.LocalDiscriminator == nil) != (other.LocalDiscriminator == nil) {
		return false
	} else if in.LocalDiscriminator != nil {
		if *in.LocalDiscriminator != *other.LocalDiscriminator {
			return false
		}
	}

	if (in.RemoteDiscriminator == nil) != (other.RemoteDiscriminator == nil) {
		return false
	} else if in.RemoteDiscriminator != nil {
		if *in.RemoteDiscriminator != *other.RemoteDiscriminator {
			return false
		}
	}

	if (in.FailureTransitions == nil) != (other.FailureTransitions == nil) {
		return false
	} else if in.FailureTransitions != nil {
		if *in.FailureTransitions != *other.FailureTransitions {
			return false
		}
	}
...
func (in *CiliumBGPNodePeerStatus) DeepEqual(other *CiliumBGPNodePeerStatus) bool {
	...
	if (in.BFDState == nil) != (other.BFDState == nil) {
		return false
	} else if in.BFDState != nil {
		if !in.BFDState.DeepEqual(other.BFDState) {
			return false
		}
	}
