...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPBFD) DeepCopyInto(out *CiliumBGPBFD) {
	*out = *in
	if in.DesiredMinTxInterval != nil {
		in, out := &in.DesiredMinTxInterval, &out.DesiredMinTxInterval
		*out = new(uint32)
		**out = **in
	}
	if in.RequiredMinRxInterval != nil {
		in, out := &in.RequiredMinRxInterval, &out.RequiredMinRxInterval
		*out = new(uint32)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPBFD.
func (in *CiliumBGPBFD) DeepCopy() *CiliumBGPBFD {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPBFD)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPBFDState) DeepCopyInto(out *CiliumBGPBFDState) {
	*out = *in
	...
	if in.RemoteSessionState != nil {
		in, out := &in.RemoteSessionState, &out.RemoteSessionState
		*out = new(string)
		**out = **in
	}
	if in.LocalDiagnosticCode != nil {
		in, out := &in.LocalDiagnosticCode, &out.LocalDiagnosticCode
		*out = new(string)
		**out = **in
	}
	if in.RemoteDiagnosticCode != nil {
		in, out := &in.RemoteDiagnosticCode, &out.RemoteDiagnosticCode
		*out = new(string)
		**out = **in
	}
	...
	if in.FailureTransitions != nil {
		in, out := &in.FailureTransitions, &out.FailureTransitions
		*out = new(uint64)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPBFDState.
func (in *CiliumBGPBFDState) DeepCopy() *CiliumBGPBFDState {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPBFDState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CiliumBGPNodePeerStatus) DeepCopyInto(out *CiliumBGPNodePeerStatus) {
	*out = *in
	...
	if in.BFDState != nil {
		in, out := &in.BFDState, &out.BFDState
		*out = new(CiliumBGPBFDState)
		(*in).DeepCopyInto(*out)
	}
	return
